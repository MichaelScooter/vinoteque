...
<div class="container-fluid g-0 d pt-5">
    <div>
        <div class="position-relative">
            <img src="images/gin_smagning_mobil.webp" alt="Tag med på en spændende rejse gennem forskellige gin-smagsnuancer til vores eksklusive smagningsevent på Vinoteque" class="w-100 d-lg-none pt-5">
            <img src="images/gin_smagning_vinoteque.webp" alt="Oplev magien ved gin og udforsk en verden af aromatiske smagsoplevelser hos Vinoteque - kom til vores smagningsevent" class="w-100 d-none d-lg-block">
...
<div class="container">
    <div class="row d-flex align-items-center text-center text-md-start">
        ...
        <div class="col-12 col-md-6">
            <img src="images/event_gin_smagning.webp" alt="Gin smagning på skibet med fantastisk udsigt" class="img-fluid h-100 rounded-3">
        </div>
    </div>
</div>
