...
<div class="container-fluid g-0 d pt-5">
    <div>
        <div class="position-relative">
            <img src="images/oel_smagning_mobil.webp" alt="Udforsk en verden af velsmagende øl til vores spændende ølsmagningsevent på Vinoteque" class="w-100 d-lg-none pt-5">
            <img src="images/oel_smagnin_vinoteque.webp" alt="Opdag en række unikke ølsmagsoplevelser hos Vinoteque - kom til vores smagningsevent og bliv inspireret" class="w-100 d-none d-lg-block">
...
<div class="container">
    <div class="row d-flex align-items-center text-center text-md-start">
        ...
        <div class="col-12 col-md-6">
            <img src="images/event_oel_smagning.webp" alt="Ølsmagning på skibet med fantastisk udsigt" class="img-fluid h-100 rounded-3">
        </div>
    </div>
</div>
